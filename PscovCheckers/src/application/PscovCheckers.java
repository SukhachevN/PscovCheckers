    	...
    	try {
    		...
    		if(!check) {
    			...
    			for(int i = 0;i<3;i++) {
    				...
    				if(x1-2>=0) {
    					if(board[x1-1][checkY].hasPiece() && board[x1-1][checkY].getPiece().getType()!= piece.getType() &&
                         		 !board[x1-2][checkY].hasPiece()) {
    						newX = x1-2;
                        	if(board[x1-1][checkY-1].hasPiece() && board[x1-1][checkY-1].getPiece().getType()== piece.getType() ||
